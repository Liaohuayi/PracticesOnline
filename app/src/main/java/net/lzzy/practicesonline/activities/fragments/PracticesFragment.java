...
public class PracticesFragment extends BaseFragment {
    ...
    private void saveQuestion(String json, UUID practiceId) {
        try {
            List<Question> questions = QuestionService.getQuestion(json, practiceId);
    ...
    static class QuestionDownLoader extends AsyncTask<Integer, Void, String> {
        ...
        protected String doInBackground(Integer... integers) {
            ...
            try {
                return QuestionService.getQuestionsOfParacticeFromServer(practice.getApiId());
            } catch (IOException e) {
                return e.getMessage();
            }
        }
    ...
    private void downloadQuestion(int apiId) {
        ...
        executor.execute(new Runnable() {
            ...
            public void run() {
                try {
                    String json = QuestionService.getQuestionsOfParacticeFromServer(apiId);
