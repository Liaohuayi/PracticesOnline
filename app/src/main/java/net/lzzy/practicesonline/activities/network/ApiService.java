...
public class ApiService {
    ...
    public static String okPost(String address, String args, HashMap<String,Object>headers) throws IOException{
    ...
    public static String okRequest(String address, JSONObject json)throws IOException{
        RequestBody body=RequestBody.create(MediaType.parse("application/json; charset=tuf-8"),
                json.toString());
