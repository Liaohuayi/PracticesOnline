...
public class QuestionService {
    public static String getQuestionsOfParacticeFromServer(int apiId) throws IOException {
        String address= ApiConstants.URL_QUESTIONS+apiId;
        return ApiService.okGet(address);
    }

    public static List<Question>getQuestion(String json, UUID practiceId) throws IllegalAccessException, JSONException, InstantiationException {
